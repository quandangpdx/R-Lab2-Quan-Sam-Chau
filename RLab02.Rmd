...
date <-  raw_date %>% mutate(
  m=case_when(raw_date$month=="(April"~"04",
              raw_date$month=="(March"~"03"))
...
# date$day <- str_pad(date$day, 2, side="left", pad="0")
...
head(wide_IPS_sampledata)
nrow(wide_IPS_sampledata);
```
